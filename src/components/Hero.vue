<template>
  <div class="container mt-16 flex justify-between items-center mx-auto px-8">
      <div class="flex-wrap md:flex-nowrap">
          <nav class="inline-block lg:mr-24 lg:w-4 fixed left-percentaje hidden xl:block">
          ...
          <img src="../assets/hero.svg" alt="hero" class="w-3/4 mt-12 md:absolute -mt-6 md:mt-0 right-0 -z-1">
      </div>
  </div>
</template>
